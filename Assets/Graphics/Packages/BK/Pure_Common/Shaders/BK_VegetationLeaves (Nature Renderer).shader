...
Shader "BK/VegetationLeaves (Nature Renderer)"
{
	Properties
	{
	...
	SubShader
	{
		...
		Tags { "RenderPipeline"="UniversalPipeline" "RenderType"="Opaque" "Queue"="Geometry" "UniversalMaterialType"="Lit"  "NatureRendererInstancing"="True" }
		...
		Pass
		{
			...
			Name "Forward"
			Tags { "LightMode"="UniversalForwardOnly"  "NatureRendererInstancing"="True" }
		...
		Pass
		{
			...
			Name "DepthNormals"
			Tags { "LightMode"="DepthNormalsOnly"  "NatureRendererInstancing"="True" }
