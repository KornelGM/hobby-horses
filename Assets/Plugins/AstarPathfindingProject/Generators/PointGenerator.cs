...
namespace Pathfinding {
	...
	public class PointGraph : NavGraph
		...
		/// </summary>
		public PointNode AddNode (Int3 position, uint tag) {
			return AddNode(new PointNode(active), position, tag);
		}
		...
		public T AddNode<T>(T node, Int3 position, uint tag) where T : PointNode {
