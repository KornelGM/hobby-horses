...
namespace Pathfinding {
	...
	public class NodeLink3 : GraphModifier {
		...
		[Tooltip("Node tag index")]
		[Range(0, 31)]
		public uint nodeTag = 0;
		...
		public void InternalOnPostScan () {
			...
			startNode = AstarPath.active.data.pointGraph.AddNode(new NodeLink3Node(AstarPath.active), (Int3)StartTransform.position, nodeTag);
			startNode.link = this;
			endNode = AstarPath.active.data.pointGraph.AddNode(new NodeLink3Node(AstarPath.active), (Int3)EndTransform.position, nodeTag);
			endNode.link = this;
#else
