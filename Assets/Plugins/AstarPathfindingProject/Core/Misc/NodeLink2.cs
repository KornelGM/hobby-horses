...
namespace Pathfinding {
	...
	public class NodeLink2 : GraphModifier {
		...
		public void InternalOnPostScan()
		{
			...
			if (startNode == null)
			{
				startNode = AstarPath.active.data.pointGraph.AddNode((Int3)StartTransform.position, nodeTag);
			}
			if (endNode == null)
			{
				endNode = AstarPath.active.data.pointGraph.AddNode((Int3)EndTransform.position, nodeTag);
			}
