...
public static class AStar
{
    ...
    public static List<Node> FindPath(Transform start, Transform target, List<Node> nodes)
    {
        Node startNode = FindClosestNode(start.position, nodes);
        Node targetNode = FindClosestNode(target.position, nodes);
