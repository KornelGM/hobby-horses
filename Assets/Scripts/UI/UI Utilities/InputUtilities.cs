...
{
    private static readonly List<ActionElementMap> MapLookupResults = new();

    /// <summary>
    /// Find the first mapping that is for this controller and with the correct pole direction. Null if no such map exists.
    /// </summary>
    public static ActionElementMap GetActionElementMap(Player player, ControllerType controller, int actionID, Pole pole)
    {
